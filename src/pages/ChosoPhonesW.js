  ...
  return (
    <div className='ph-container'>
      <div className="iphone-container">
        ...
        <div className="iphone-screen">
          ...
          <video autoPlay muted loop className="wallpaper-video">
            <source src={assets.choso_phones} type="video/mp4" />
      ...
      <div className='free-download'>
        <h2>CHOSO WALLPAPER </h2>
        <p>Choso live Wallpaper 4k for free, Download below: </p>
        <button>
          <a href={assets.choso_phones} download>Free Download</a>
        </button>
      </div>
    </div>
  );
