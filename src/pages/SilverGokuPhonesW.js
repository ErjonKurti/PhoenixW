  ...
  return (
    <div className='ph-container'>
      <div className="iphone-container">
        ...
        <div className="iphone-screen">
          ...
          <video autoPlay muted loop className="wallpaper-video">
            <source src={assets.silvergoku_phones} type="video/mp4" />
      ...
      <div className='free-download'>
        <h2>SILVER GOKU WALLPAPER </h2>
        <p>Silver Goku live Wallpaper 4k for free, Download below: </p>
        <button>
          <a href={assets.silvergoku_phones} download>Free Download</a>
        </button>
      </div>
    </div>
  );
...
export default SilverGokuPhonesW;
