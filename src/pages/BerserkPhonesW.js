  ...
  return (
    <div className='ph-container'>
      <div className="iphone-container">
        ...
        <div className="iphone-screen">
          ...
          <video autoPlay muted loop className="wallpaper-video">
            <source src={assets.berserk_phones} type="video/mp4" />
      ...
      <div className='free-download'>
        <h2>BERSERK WALLPAPER </h2>
        <p>Berserk live Wallpaper 4k for free, Download below: </p>
        <button>
          <a href={assets.berserk_phones} download>Free Download</a>
        </button>
      </div>
    </div>
  );
