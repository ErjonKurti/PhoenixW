  ...
  return (
    <div className='ph-container'>
      <div className="iphone-container">
        ...
        <div className="iphone-screen">
          ...
          <video autoPlay muted loop className="wallpaper-video">
            <source src={assets.zoro_phones} type="video/mp4" />
      ...
      <div className='free-download'>
        <h2>ZORO WALLPAPER </h2>
        <p>Zoro live Wallpaper 4k for free, Download below: </p>
        <button>
          <a href={assets.zoro_phones} download>Free Download</a>
        </button>
      </div>
    </div>
  );
