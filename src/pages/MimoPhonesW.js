  ...
  return (
    <div className='ph-container'>
      <div className="iphone-container">
        ...
        <div className="iphone-screen">
          ...
          <video autoPlay muted loop className="wallpaper-video">
            <source src={assets.mimo} type="video/mp4" />
      ...
      <div className='free-download'>
        <h2>MIMO WALLPAPER </h2>
        <p>Mimo on his feels live Wallpaper 4k for free, Download below: </p>
        <button>
          <a href={assets.mimo} download>Free Download</a>
        </button>
      </div>
    </div>
  );
