  ...
  return (
    <div className='ph-container'>
      <div className="iphone-container">
        ...
        <div className="iphone-screen">
          ...
          <video autoPlay muted loop className="wallpaper-video">
            <source src={assets.poku} type="video/mp4" />
      ...
      <div className='free-download'>
        ...
        <p>Poku the gambler live Wallpaper 4k for free, Download below: </p>
        <button>
          <a href={assets.poku} download>Free Download</a>
        </button>
      </div>
    </div>
  );
