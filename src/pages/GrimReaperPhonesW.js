  ...
  return (
    <div className='ph-container'>
      <div className="iphone-container">
        ...
        <div className="iphone-screen">
          ...
          <video autoPlay muted loop className="wallpaper-video">
            <source src={assets.grimreaper_phones} type="video/mp4" />
      ...
      <div className='free-download'>
        <h2>GRIM REAPER WALLPAPER </h2>
        <p>Grim Reaper live Wallpaper 4k for free, Download below: </p>
        <button>
          <a href={assets.grimreaper_phones} download>Free Download</a>
        </button>
      </div>
    </div>
  );
...
export default GrimReaperPhonesW;
