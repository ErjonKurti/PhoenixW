  ...
  return (
    <div className='ph-container'>
      <div className="iphone-container">
        ...
        <div className="iphone-screen">
          ...
          <video autoPlay muted loop className="wallpaper-video">
            <source src={assets.joker_phones} type="video/mp4" />
      ...
      <div className='free-download'>
        <h2>JOKER WALLPAPER </h2>
        <p>Joker live Wallpaper 4k for free, Download below: </p>
        <button>
          <a href={assets.joker_phones} download>Free Download</a>
        </button>
      </div>
    </div>
  );
