  ...
  return (
    <div className='ph-container'>
      <div className="iphone-container">
        ...
        <div className="iphone-screen">
          ...
          <video autoPlay muted loop className="wallpaper-video">
            <source src={assets.kakashi_phones} type="video/mp4" />
      ...
      <div className='free-download'>
        <h2>KAKASHI WALLPAPER </h2>
        <p>Kakashi live Wallpaper 4k for free, Download below: </p>
        <button>
          <a href={assets.kakashi_phones} download>Free Download</a>
        </button>
      </div>
    </div>
  );
