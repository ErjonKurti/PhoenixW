  ...
  return (
    <div className='ph-container'>
      <div className="iphone-container">
        ...
        <div className="iphone-screen">
          ...
          <video autoPlay muted loop className="wallpaper-video">
            <source src={assets.korra_phones} type="video/mp4" />
      ...
      <div className='free-download'>
        <h2>KORRA WALLPAPER </h2>
        <p>Avatar Korra live Wallpaper 4k for free, Download below: </p>
        <button>
          <a href={assets.korra_phones} download>Free Download</a>
        </button>
      </div>
    </div>
  );
