  ...
  return (
    <div className='ph-container'>
      <div className="iphone-container">
        ...
        <div className="iphone-screen">
          ...
          <video autoPlay muted loop className="wallpaper-video">
            <source src={assets.ghostcod_phones} type="video/mp4" />
      ...
      <div className='free-download'>
        <h2>GHOST WALLPAPER </h2>
        <p>Ghost live Wallpaper 4k for free, Download below: </p>
        <button>
          <a href={assets.ghostcod_phones} download>Free Download</a>
        </button>
      </div>
    </div>
  );
...
export default GhostCodPhonesW;
