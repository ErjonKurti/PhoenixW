  ...
  return (
    <div className='ph-container'>
      <div className="iphone-container">
        ...
        <div className="iphone-screen">
          ...
          <video autoPlay muted loop className="wallpaper-video">
            <source src={assets.gothgirl_phones} type="video/mp4" />
      ...
      <div className='free-download'>
        <h2>GOTH GIRL WALLPAPER </h2>
        <p>Goth Girl live Wallpaper 4k for free, Download below: </p>
        <button>
          <a href={assets.gothgirl_phones} download>Free Download</a>
        </button>
      </div>
    </div>
  );
...
export default GothGirlPhonesW;
